...
// const NoticeSection = () => {
//   return (
//     <div className="font-sans text-gray-800 p-4 md:p-8">
//       {/* Header */}
...
//             पतसंस्थेची निर्मिती झाली. दि. 05/02/2021 रोजी संस्थापक अध्यक्ष श्री
//             सुरेश एम. सायगांव साहेब व चेअरमनसो सौ सुप्रिया गणेश काळे यांनी
...
//             पार केला आहे. सर्वोत्तम व्यवस्थापन, विश्वासार्हता, नवीनतम-तंत्रज्ञान
...
//             <div 
//               ref={popupRef} 
//               className="bg-white p-8 rounded-lg shadow-lg max-w-xl w-full mx-4 relative z-50"
//             >
//               {/* Close Button */}
//               <button
//                 onClick={() => setShowPopup(false)}
...
//                 <div className="space-y-6">
//                   <h3 className="text-lg font-semibold">आपत्ती थकबाकी वेळेवर भरल्याने:</h3>
