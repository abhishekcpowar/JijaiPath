  ...
  <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div className="bg-white rounded-lg w-full max-w-3xl max-h-[90vh] overflow-hidden relative">
      <div className="p-4 border-b flex justify-between items-center">
        <h2 className="text-xl font-semibold">Apply for Vehicle Loan</h2>
        <button
          ...
          <div className="py-8 px-4 md:py-12 md:px-6 lg:px-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                आता त्यांची स्वप्न साकार होईल जिजाई अर्बन पतसंस्थेच्या वाहन तारण कर्जामुळे.
              ...
              <div className="flex flex-col space-y-4">
                <ul className="space-y-4">
                  ...
                  <ul className="pl-8 text-lg list-disc text-gray-700 space-y-1">
                    <li>वाहनाच्या किंमतीचे कोटेशन (ऑन रोड किंमत)</li>
                    <li>कोटेशनच्या 25% रक्कम संस्थेकडे जमा करावी</li>
