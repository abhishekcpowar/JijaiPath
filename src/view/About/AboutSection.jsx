...
// import Tableupdated from "../../assets/images/Tableupdated.png"
...
//                 </div>
//               </div>
//               <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4 px-4 sm:px-10 md:px-20">
...
//                 असलेला या रोपट्याच आज वटवृक्षात रुपांतर झालेले आहे. आपुलकीची
//                 सेवा आणि खूप मोठी विश्वासाची थाप या जोरावर संस्थेने नुकताच 3
//                 कोटीच्या एकत्रित व्यवसायाचा टप्पा पार केला आहे. सर्वोत्तम
...
//                 तंत्रज्ञानाचा योग्य वापर केला जातो. ग्राहकांना मोबाईल बँकिंग,
//                 इंटरनेट बँकिंग, ATM कार्ड, NEFT/RTGS/IMPS सेवा, स्वाईप मशीन इ.
//                 सेवा उपलब्ध आहेत.
//               </p>
...
//     src={Tableupdated} 
//     alt="Header" 
//     className="px-8 py-5 sm:px-20 md:px-20 flex justify-center items-center" 
//   />
// </div>
//             </div>
//           </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-6 text-justify px-4 sm:px-10 md:px-20">
                <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                  ...
                  सेवा आणि खूप मोठी विश्वासाची थाप या जोरावर संस्थेने नुकताच 3
                  कोटीच्या एकत्रित व्यवसायाचा टप्पा पार केला आहे. तसेच या संपूर्ण प्रवासामधे संस्थेला श्री.गणेश काळे व 
                  श्री. यल्लेश कोळी यांचे मार्गदर्शन लाभले. सर्वोत्तम
                  व्यवस्थापन, विश्वासार्हता, नवीनतम-तंत्रज्ञान आणि सामाजिक
                  बांधिलकी हे सर्व जिजाई अर्बनच्या यशमागील रहस्य आहेत. तुमच्यासाठी
                  सर्वोत्तम साध्य करण्यासाठी आम्ही आमचे सर्वोत्तम देणे सुरू ठेवू.
                </p>
